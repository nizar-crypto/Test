...
const inStockCost = products.reduce((accu, product) => {
  console.log("check instock", accu, product.inStock === true, product.cost);
  if (product.inStock === true) {
    return accu + product.cost;
  } else {
    return accu;
  }
}, 0);
console.log(
  "The amount of money it costs to buy 1 of each product is: ",
  inStockCost
);
