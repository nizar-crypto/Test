...
const mixProducts = products.filter((product) => {
  console.log("check mix", product.productName.includes("Mix"));
  return product.productName.includes("Mix");
});
console.log('All products which are a "Mix"', mixProducts);
