...
var output = projects.filter(function between1000And4000(project) {
  //   console.log("check project", project);
  //   var between1000And4000 =project.donationAmount >= 2000 && project.donationAmount <= 4000;

  return project.donationAmount >= 2000 && project.donationAmount <= 4000;
});
console.log(output);
