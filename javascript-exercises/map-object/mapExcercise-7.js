...
//   ];
var output = [];
console.log("check user", roundBalance);
for (let index = 0; index < users.length; index++) {
  const user = users[index];
  //   var user = users[0]
  var roundBalance = user.balance.toFixed(0);
  user.balance = parseInt(roundBalance);
  //   var balance = balance.roundBalance;

  console.log(roundBalance);
  output.push(user);
}
console.log(output);
