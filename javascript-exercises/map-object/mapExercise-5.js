...
// 1. Desired output: ["193.149.16.215","46.183.83.114", "253.35.252.223", etc...]
var output = [];
for (let index = 0; index < users.length; index++) {
  const user = users[index];
  //   var user = users[0];
  var userIpAddress = user.ip_address;
  //   console.log("check IP", userIpAddress);
  output.push(user.ip_address);
}
console.log(output);
